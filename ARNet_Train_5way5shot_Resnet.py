...
parser.add_argument('--neighbor_k', type=int, default=5, help='the number of k-nearest neighbors')
...
parser.add_argument('--print_freq', '-p', default=1, type=int, metavar='N', help='print frequency (default: 100)')
